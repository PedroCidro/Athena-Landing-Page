...
const siteDescription =
  "Criamos sites profissionais que transformam visitantes em clientes. Landing pages, sites institucionais e lojas virtuais com design premium e tecnologia de ponta.";
...
const jsonLd = {
  ...
  "@graph": [
    ...
    },
    {
      ...
      description:
        "Páginas de alta conversão para campanhas e captação de leads.",
      offers: {
        "@type": "Offer",
        price: "1500",
        priceCurrency: "BRL",
    ...
    },
    {
      ...
      description:
        "Presença digital completa para sua empresa ou consultório.",
      offers: {
        "@type": "Offer",
        price: "3500",
        priceCurrency: "BRL",
...
export default function LandingLayout({
  ...
  return (
    <>
      ...
      {/* Google Ads Tag */}
      <Script
        src="https://www.googletagmanager.com/gtag/js?id=AW-17915619735"
